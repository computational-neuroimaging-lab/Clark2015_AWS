...
\usepackage[orientation=portrait,size=custom,width=141,height=242,scale=1]{beamerposter}
    ...
    %\begin{minipage}[T]{.98\textwidth}  % tweaks the width, makes a new \textwidth
        ...
        \begin{block}{Methods}
            ...
            \begin{column}{.5\textwidth}
                ...
                \end{figure}
                %% C-PAC pipeline figure
                \begin{figure}
                    \begin{center}
                        \includegraphics[width=.9\textwidth]{cpac_pipeline.png}
                    \end{center}
                    \caption{\label{fig:cpac_pipe}C-PAC preprocessing stages}
                \end{figure}
            \end{column}
            \vskip1ex
            %% C-PAC pipeline
