...
\usepackage[orientation=portrait,size=custom,width=141,height=101,scale=1]{beamerposter}
...
\begin{frame}
            ...
            \begin{column}{.5\textwidth}
	            ...
	            {\bf Interacting with the NDAR database}
	                \begin{itemize}
	                    ...
	                    \item Launch an AWS EC2 HPC cluster using Starcluster (\url{http://star.mit.edu/cluster/})
    ...
    %\begin{minipage}[T]{.98\textwidth} % tweaks the width, makes a new \textwidth
        ...
        \begin{block}{Results cont.}
            ...
            \begin{itemize}
                \item Models assume that users upload their input data to the cloud, run their pipelines and (optionally) downloads their outputs as they become available.
