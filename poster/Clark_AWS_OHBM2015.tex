			 ...
			 \end{center}
              \begin{column}{.47\textwidth}
                  ...
                  \begin{figure}
                      ...
                      \caption{\label{fig:cpac-costs}AWS EC2 costs, grouped by cost type, for a typical C-PAC pipeline for different sized datasets versus owning and maintaining own server}
                  \end{figure}
                  %% C-PAC times figure
                  \begin{figure}
