...
\usepackage[orientation=portrait,size=custom,width=110,height=123,scale=1]{beamerposter}
...
\institute[NKI]{$^1$Center for the Developing Brain, Child Mind Institute, New York, NY, $^2$University of Massachuttes Medical School, Worcester, MA, $^3$Laboratory of Neuro Imaging, Keck School of Medicine, University of Southern California, Los Angeles, CA, $^4$UCLA, Los Angeles, CA, $^5$Computational Neuroimaging Lab, Center for Biomedical Imaging and Neuromodulation, Nathan S. Kline Institute for Psychiatric Research, Orangeburg, NY}

%% Poster info
\posternum{\Large P24, August 21, 2015}
\gitrepo{http://www.github.com/computational-neuroimaging-lab/Clark2015\_AWS}
\date[August 21st, 2015]{August 21st, 2015}
        ...
        \begin{block}{Methods}
            ...
            \end{itemize}
                ...
                \begin{figure}
                    ...
                    \includegraphics[]{spot_history.png}
...
%	}
        ...
        \begin{block}{Results}
            \begin{center}
                ...
                \begin{table}
                    ...
                    \vskip2ex
					%%\begin{tabularx}{.9\textwidth}{XXlrl*{6}{r}}
                    \begin{tabularx}{.85\textwidth}{Xrlrl*{6}{r}}
	...
	\begin{columns}
        ...
        1. Hall, D. et al. (2012), Neuroinformatics. 10(4):331-9, 2. Torgerson, C.M. et al. (2015), Brain Imaging and Behavior 9:89-103, 3. Craddock, R.C. et al. (2013), Frontiers in Neuroinformatics 42, 4. Das, S.R. et al. (2009), Neuroimage, 45(3): 867-79, 5. Shehzad, Z. et al. (2014), Resting State Conference, Boston,  6. Haselgrove, C. et al. (2014), Front. Neuroinform. 8:52\\
        \vskip.5ex
        %% Support
