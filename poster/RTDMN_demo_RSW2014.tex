...
%\title{\vskip2ex\huge ROI Atlas Generation from Whole Brain Parcellation of\\[.5ex] Resting State fMRI Data}
       ...
       % \begin{minipage}[T]{.98\textwidth} % tweaks the width, makes a new \textwidth
          \parbox[t][\columnheight]{\textwidth}{ % must be some better way to set the the height, width and textwidth simultaneously
            ...
            \begin{block}{Results}
              \begin{column}{.47\textwidth}
                  \begin{figure}
                      \includegraphics[width=.99\textwidth]{best_worst.eps}
                      \caption{\label{fig:best_worst}Example of classifier and feedback timecourse for participants with the best and worst performance.}
                  \end{figure}
                  \vskip2ex
                  \begin{figure}
